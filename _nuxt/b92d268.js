!function() {
    try {
        ...
        e._posthogChunkIds[n] = "01a011d4-0305-7483-9c9f-1d2613d23ab6")
    } catch (e) {}
}();
            ...
            !function() {
                ...
                _.prototype = {
                    ...
                    volume: function() {
                        ...
                        if (0 === r.length)
                            return o._volume;
                        if (1 === r.length || 2 === r.length && void 0 === r[1] ? o._getSoundIds().indexOf(r[0]) >= 0 ? n = parseInt(r[0], 10) : e = parseFloat(r[0]) : r.length >= 2 && (e = parseFloat(r[0]),
                        n = parseInt(r[1], 10)),
                        !(void 0 !== e && e >= 0 && e <= 1))
                    ...
                    rate: function() {
                        ...
                        for (var i = 0; i < n.length; i++)
                            if (t = o._soundById(n[i])) {
                                ...
                                o._endTimers[n[i]] = setTimeout(o._ended.bind(o, t), l)),
                                o._emit("rate", t._id)
                            }
                        return o
                    },
...
//# chunkId=01a011d4-0305-7483-9c9f-1d2613d23ab6
